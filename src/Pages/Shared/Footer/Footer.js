...
const Footer = () => {
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <Link to="/" className="text-gray-600">Angular</Link>
        </p>
        <p className="mb-4">
          <Link to="/" className="text-gray-600">React</Link>
        </p>
        <p className="mb-4">
          <Link to="/" className="text-gray-600">Vue</Link>
        </p>
        <p>
          <Link to="/" className="text-gray-600">Laravel</Link>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p className="mb-4">
          <Link to="/" className="text-gray-600">Settings</Link>
        </p>
        <p className="mb-4">
          <Link to="/" className="text-gray-600">Orders</Link>
        </p>
        <p>
          <Link to="/" className="text-gray-600">Help</Link>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <Link className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Tailwind Elements</Link>
  </div>
</footer>
    );
};
